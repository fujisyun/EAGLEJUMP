...
static const char __pyx_k_home_rgommers_Code_scipy_scipy[] = "/home/rgommers/Code/scipy/scipy/optimize/_lsq/givens_elimination.pyx";
...
static PyObject *__pyx_pw_5scipy_8optimize_4_lsq_18givens_elimination_1givens_elimination(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("givens_elimination (wrapper)", 0);
  {
    ...
    __pyx_v_S = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(values[0]); if (unlikely(!__pyx_v_S.memview)) __PYX_ERR(0, 10, __pyx_L3_error)
    __pyx_v_v = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[1]); if (unlikely(!__pyx_v_v.memview)) __PYX_ERR(0, 10, __pyx_L3_error)
    __pyx_v_diag = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[2]); if (unlikely(!__pyx_v_diag.memview)) __PYX_ERR(0, 10, __pyx_L3_error)
  }
 ...
 * 
 */
  __pyx_tuple__14 = PyTuple_Pack(15, __pyx_n_s_S, __pyx_n_s_v, __pyx_n_s_diag, __pyx_n_s_n, __pyx_n_s_k, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_f, __pyx_n_s_g, __pyx_n_s_r, __pyx_n_s_cs, __pyx_n_s_sn, __pyx_n_s_one, __pyx_n_s_diag_row, __pyx_n_s_u); if (unlikely(!__pyx_tuple__14)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__14);
  __Pyx_GIVEREF(__pyx_tuple__14);
  __pyx_codeobj__15 = (PyObject*)__Pyx_PyCode_New(3, 0, 15, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__14, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_rgommers_Code_scipy_scipy, __pyx_n_s_givens_elimination, 10, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__15)) __PYX_ERR(0, 10, __pyx_L1_error)
...
#endif
{
  ...
  __pyx_t_1 = __Pyx_ImportModule("scipy.linalg.cython_lapack"); if (!__pyx_t_1) __PYX_ERR(0, 1, __pyx_L1_error)
  ...
  if (__Pyx_ImportFunction(__pyx_t_2, "drot", (void (**)(void))&__pyx_f_5scipy_6linalg_11cython_blas_drot, "void (int *, __pyx_t_5scipy_6linalg_11cython_blas_d *, int *, __pyx_t_5scipy_6linalg_11cython_blas_d *, int *, __pyx_t_5scipy_6linalg_11cython_blas_d *, __pyx_t_5scipy_6linalg_11cython_blas_d *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
 ...
 * 
 */
  __pyx_t_3 = PyCFunction_NewEx(&__pyx_mdef_5scipy_8optimize_4_lsq_18givens_elimination_1givens_elimination, NULL, __pyx_n_s_scipy_optimize__lsq_givens_elimi); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_givens_elimination, __pyx_t_3) < 0) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
