...
static const char __pyx_k_home_rgommers_Code_scipy_scipy[] = "/home/rgommers/Code/scipy/scipy/signal/_max_len_seq_inner.pyx";
...
static PyObject *__pyx_pw_5scipy_6signal_18_max_len_seq_inner_1_max_len_seq_inner(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("_max_len_seq_inner (wrapper)", 0);
  {
    ...
    __pyx_v_taps = __Pyx_PyObject_to_MemoryviewSlice_dc_Py_ssize_t(values[0]); if (unlikely(!__pyx_v_taps.memview)) __PYX_ERR(0, 13, __pyx_L3_error)
    __pyx_v_state = __Pyx_PyObject_to_MemoryviewSlice_dc_nn___pyx_t_5numpy_int8_t(values[1]); if (unlikely(!__pyx_v_state.memview)) __PYX_ERR(0, 14, __pyx_L3_error)
    ...
    __pyx_v_seq = __Pyx_PyObject_to_MemoryviewSlice_dc_nn___pyx_t_5numpy_int8_t(values[4]); if (unlikely(!__pyx_v_seq.memview)) __PYX_ERR(0, 16, __pyx_L3_error)
  }
 ...
 */
  ...
  __pyx_t_10 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_10);
  __pyx_t_11 = __Pyx_PyObject_GetAttrStr(__pyx_t_10, __pyx_n_s_roll); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_11);
  __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
  __pyx_t_10 = __pyx_memoryview_fromslice(__pyx_v_state, 1, (PyObject *(*)(char *)) __pyx_memview_get_nn___pyx_t_5numpy_int8_t, (int (*)(char *, PyObject *)) __pyx_memview_set_nn___pyx_t_5numpy_int8_t, 0);; if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_10);
  __pyx_t_12 = PyInt_FromSsize_t((-__pyx_v_idx)); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 31, __pyx_L1_error)
  ...
  __pyx_t_10 = 0;
  __pyx_t_12 = 0;
  __pyx_t_12 = PyDict_New(); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_12);
  if (PyDict_SetItem(__pyx_t_12, __pyx_n_s_axis, __pyx_int_0) < 0) __PYX_ERR(0, 31, __pyx_L1_error)
  __pyx_t_10 = __Pyx_PyObject_Call(__pyx_t_11, __pyx_t_13, __pyx_t_12); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_10);
 ...
 *                        Py_ssize_t nbits, Py_ssize_t length,
 */
  __pyx_tuple__23 = PyTuple_Pack(10, __pyx_n_s_taps, __pyx_n_s_state, __pyx_n_s_nbits, __pyx_n_s_length, __pyx_n_s_seq, __pyx_n_s_n_taps, __pyx_n_s_idx, __pyx_n_s_feedback, __pyx_n_s_i, __pyx_n_s_ti); if (unlikely(!__pyx_tuple__23)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__23);
  __Pyx_GIVEREF(__pyx_tuple__23);
  __pyx_codeobj__24 = (PyObject*)__Pyx_PyCode_New(5, 0, 10, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__23, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_rgommers_Code_scipy_scipy, __pyx_n_s_max_len_seq_inner, 13, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__24)) __PYX_ERR(0, 13, __pyx_L1_error)
