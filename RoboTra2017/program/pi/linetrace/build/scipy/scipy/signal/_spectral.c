...
static PyObject *__pyx_pw_5scipy_6signal_9_spectral_1lombscargle(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_y)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("lombscargle", 1, 3, 3, 1); __PYX_ERR(0, 19, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_freqs)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("lombscargle", 1, 3, 3, 2); __PYX_ERR(0, 19, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "lombscargle") < 0)) __PYX_ERR(0, 19, __pyx_L3_error)
      }
  ...
  __Pyx_RaiseArgtupleInvalid("lombscargle", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 19, __pyx_L3_error)
  __pyx_L3_error:;
 ...
 */
  ...
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyInt_From_Py_intptr_t((__pyx_v_freqs->dimensions[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 133, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_float64); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 133, __pyx_L1_error)
 ...
 *             ((c_tau * xs - s_tau * xc)**2 / \
 */
    __pyx_t_6 = PyFloat_FromDouble((0.5 * ((__pyx_t_17 / __pyx_t_22) + (__pyx_t_23 / __pyx_t_24)))); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 166, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    if (unlikely(__Pyx_SetItemInt(__pyx_v_pgram, __pyx_v_i, __pyx_t_6, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 0) < 0)) __PYX_ERR(0, 166, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  }
 ...
 *     # Create empty array for output periodogram
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_s_Input_arrays_do_not_have_the_sam); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 130, __pyx_L1_error)
 ...
 *                 np.ndarray[np.float64_t, ndim=1] freqs):
 */
  __pyx_tuple__11 = PyTuple_Pack(19, __pyx_n_s_x, __pyx_n_s_y, __pyx_n_s_freqs, __pyx_n_s_pgram, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_c, __pyx_n_s_s, __pyx_n_s_xc, __pyx_n_s_xs, __pyx_n_s_cc, __pyx_n_s_ss, __pyx_n_s_cs, __pyx_n_s_tau, __pyx_n_s_c_tau, __pyx_n_s_s_tau, __pyx_n_s_c_tau2, __pyx_n_s_s_tau2, __pyx_n_s_cs_tau); if (unlikely(!__pyx_tuple__11)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__11);
  __Pyx_GIVEREF(__pyx_tuple__11);
  __pyx_codeobj__12 = (PyObject*)__Pyx_PyCode_New(3, 0, 19, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__11, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_rgommers_Code_scipy_scipy, __pyx_n_s_lombscargle, 19, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__12)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
 ...
 *                 np.ndarray[np.float64_t, ndim=1] freqs):
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5scipy_6signal_9_spectral_1lombscargle, NULL, __pyx_n_s_scipy_signal__spectral); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_t_1, __pyx_kp_u_lombscargle_line_19, __pyx_kp_u_lombscargle_x_y_freqs_Computes) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
